...
class BaseMigrationTask {
    constructor(args) {
        ...
        this.clientCosmos               = args.clientCosmos
        this.clientCosmosSubscription   = args.clientCosmosSubscription
    ...
    async migrateScript(script) {
       ...
       return this.runMigration(sqlObject);
    }
